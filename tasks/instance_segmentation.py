...
class TaskInstanceSegmentation(task_lib.Task):
    ...
    def postprocess_cpu(self, outputs, train_step,
        ...
        (images, image_ids, image_size_before_cropping, unpadded_image_size, n_instances,
        ...
        if (eval_step <= 10) or ret_results:
            ...
            for bboxes_, masks_, classes_, scores_, tag_ in val_list:
                ...
                ret_images[tag_] = add_image_summary_with_mask(
                    image_ids, images_, bboxes_, masks_, classes_, scores_, self._category_names,
                    train_step, tag)
...
def add_image_summary_with_mask(image_ids, images, bboxes, masks, classes, scores,
